...
function SpawnVehicle(x, y, z)  
	spam = false
	local vehhash = GetHashKey("jeep")    -- put here your ems car you would like to use. custom gta 5 mod https://www.gta5-mods.com/vehicles/2016-ford-explorer-fpiu-qrv-saems-els                                              
